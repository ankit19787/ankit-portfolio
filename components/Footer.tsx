const socials = [
  ...
  { label: "LinkedIn", href: "https://www.linkedin.com/in/ankitbansaldev", path: "M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zM8.3 18V10H5.8v8h2.5zM7 8.8a1.4 1.4 0 1 0 0-2.8 1.4 1.4 0 0 0 0 2.8zM18.2 18v-4.4c0-2.4-1.3-3.5-3-3.5-1.4 0-2 .8-2.3 1.3V10h-2.5v8h2.5v-4.4c0-1.2.6-1.9 1.5-1.9s1.3.7 1.3 1.9V18h2.5z" },
